...
export default function Footer() {
    return (
        <footer className="bg-primary-400 text-white py-10">
            <div className="container mx-auto px-4 lg:px-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="pr-0 md:pr-10 lg:pr-36">
                        <img src={Logo} alt="Logo" className="h-10 mb-4" />
                        <p className="mb-4 text-[16px] font-normal font-sans text-justify">
                    ...
                    <div className="pl-0 md:pl-10 lg:pl-36">
                        <p className="font-bold text-xl mb-4">Pelayanan</p>
                        <ul>
                    ...
                    <div className="pl-0 md:pl-10 lg:pl-36 text-neutral-50">
                        <p className="font-bold text-xl mb-4">Kontak</p>
                        <ul>
