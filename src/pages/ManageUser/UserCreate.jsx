...
const formSchema = zod.object({
  username: zod
    .string()
    .min(2, "Username harus memiliki minimal 2 karakter")
    .max(50, "Username maksimal 50 karakter")
    .refine((value) => !/\s/.test(value), "Username tidak boleh mengandung spasi"),
  password: zod
    .string()
      ...
      <main className="flex h-full flex-col bg-primary-50 px-10 py-6">
        <div className="mb-4 rounded-lg bg-neutral-50 p-4 shadow-md">
          ...
          <p className="text-base font-medium text-neutral-700">
            {isLoading ? (
              <Skeleton className="h-3 w-full rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
            ) : (
          ...
          <div className="grid grid-cols-12 gap-10 rounded-lg bg-neutral-50 px-6 py-8 shadow-md">
            <div className="col-span-2 flex items-start justify-center">
              <label htmlFor="foto_profil" className="cursor-pointer">
                <div className="group relative flex h-40 w-40 items-center justify-center overflow-hidden rounded-full bg-neutral-100">
                  ...
                  />
                  {isLoading ? (
                    <Skeleton className="h-40 w-40 items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
                  ) : preview ? (
                    <>
                      <img
                        src={preview}
            ...
            <div className="col-span-10 grid grid-cols-12 gap-4">
              <div className="col-span-6 mb-3">
                {isLoading ? (
                  <Skeleton className="my-3 h-3 w-80 rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
                ) : (
                  <Label
                ...
                {isLoading ? (
                  ...
                  <Input
                    ...
                    className={
                      form.formState.errors.username ? "border-danger-400" : ""
                    }
                  />
                )}
              ...
              <div className="col-span-6 mb-3">
                ...
                {isLoading ? (
                  ...
                  <Input
                    ...
                    className={
                      form.formState.errors.nama_lengkap ? "border-danger-400" : ""
                    }
                  />
                )}
              ...
              <div className="relative col-span-12 mb-3">
                {isLoading ? (
                  <Skeleton className="my-3 h-3 w-[750px] rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
                ) : (
                ...
                {isLoading ? (
                  <Skeleton className="my-3 ml-5 h-3 w-[565px] rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
                ) : (
                  <Input
                    ...
                    className={
                      form.formState.errors.password ? "border-danger-400" : ""
                    }
                  />
                )}
                {isLoading ? (
                  <Skeleton className="absolute right-3 top-8 mb-5 h-6 w-6 cursor-pointer rounded-full bg-gradient-to-r from-neutral-200 to-neutral-50/0" />
                ) : (
                  <button
              ...
              <div className="col-span-6 mb-3">
                ...
                {isLoading ? (
                  ...
                  <Input
                    ...
                    className={
                      form.formState.errors.email ? "border-danger-400" : ""
                    }
                  />
                )}
