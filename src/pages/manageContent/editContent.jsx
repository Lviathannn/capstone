...
export default function EditContent() {
  ...
  const onSubmit = async (values) => {
    ...
    form.setValue("destination_id", updatedValues.destination_id); // Update destination_id in form object
    form.setValue("title", updatedValues.title); // Update nama destinasi in form object
