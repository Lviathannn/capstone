...
export default function LandingAkses() {
    return (
        <section className="container mx-auto py-[30px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-28 py-20">
                <div className="flex flex-col justify-center px-4 md:px-8">
                    <h2 className="text-3xl md:text-4xl font-bold text-primary-500 mb-8">Dapatkan Akses Langsung Di Aplikasi Kami</h2>
                    <p className="text-base md:text-lg font-normal text-neutral-900 mb-8">
