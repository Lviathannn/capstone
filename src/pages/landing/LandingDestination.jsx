        ...
        <div className="container mx-auto py-[30px] px-4 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-center py-[30px] md:py-[70px]">
                    <h2 className="text-primary-500 text-2xl font-medium mb-4 font-jakarta-sans">
                        Poin - Poin Berwisata
                    </h2>
                    <h3 className="text-neutral-900 text-3xl md:text-4xl font-bold font-jakarta-sans mb-4">
                        Kami membantu menemukan tempat impianmu
                    </h3>
                    <p className="text-neutral-900 text-base font-normal font-jakarta-sans mb-4">
